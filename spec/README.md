...
> **Version 2 (draft):** v1 is superseded for *producing* evidence by the
> JAdES-sealed [`AiEvidenceEnvelopeV2`](./ai-evidence-envelope-v2.md) once that
> draft is accepted. v1 envelopes remain verifiable indefinitely.
